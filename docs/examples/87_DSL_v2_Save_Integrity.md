# DSL v2 Save Integrity

_Slice tag: Slice 87 — Demonstration scenario for DSL v2 Save Integrity._

## Demo Purpose
Show the slice behaviour in a compact, testable scenario focused on: save-state completeness and integrity checks.
