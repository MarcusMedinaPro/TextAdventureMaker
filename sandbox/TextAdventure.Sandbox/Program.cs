...
var bucket = new Item(
    ...
    .SetTakeable(false)
    .SetReaction(ItemAction.TakeFailed, "It is far too substantial to be carried, but you could certainly persuade it to slide into place.")
...
GameState state = new(attic, worldLocations: new[] { attic })
{
