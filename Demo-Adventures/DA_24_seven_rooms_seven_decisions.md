...
location: start | The disturbance arrives and feels personal.
  ...
  item: seven_rooms_seven_decisions_note | case note | A folded note containing partial context and names.
...
location: sidetrack | A clue reveals the scale of the problem.
  item: seven_rooms_seven_decisions_decoy | red herring | A convincing but ultimately irrelevant object.
...
location: finale | A choice narrows the world.
  item: seven_rooms_seven_decisions_token | proof token | A concrete token that confirms what is really happening.
