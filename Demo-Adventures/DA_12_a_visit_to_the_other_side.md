...
```adventure
world: A Visit to the Other Side
goal: Reach the final turn with enough context to act decisively.
current_location: start

// --- DSL v2 entity definitions ---
define item: a_visit_to_the_other_side_note | Case Note | A folded note containing partial context and names.
define item: a_visit_to_the_other_side_decoy | Red Herring | A convincing but ultimately irrelevant object.
define item: a_visit_to_the_other_side_token | Proof Token | A concrete token that confirms what is really happening.
define npc: a_visit_to_the_other_side_watcher | Watcher | A tense observer who reacts to your choices.
...
// --- Start state ---
start_inventory: a_visit_to_the_other_side_note
start_stats: health=100 | resolve=50 | trust=0
flag: alarm_heard=false
counter: tension=0
relationship: a_visit_to_the_other_side_watcher=0
...
on_pickup: a_visit_to_the_other_side_token | effects="message:This detail is real. Build your choice around it."

npc_acceptance_default: a_visit_to_the_other_side_watcher | text="The watcher says little, but notes every move."
npc_rule: a_visit_to_the_other_side_watcher | when=counter.tension>=2 | priority=1 | then="message:The watcher glances away, as if expecting impact."
...
branch: sharp_end | when=has_item:a_visit_to_the_other_side_token | then="message:You reach the ending with evidence, not guesswork."
...
SetupC64("A Visit to the Other Side");
