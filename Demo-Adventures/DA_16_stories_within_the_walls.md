...
location: start | The disturbance arrives and feels personal.
  ...
  item: stories_within_the_walls_note | case note | A folded note containing partial context and names.
...
location: sidetrack | A clue reveals the scale of the problem.
  item: stories_within_the_walls_decoy | red herring | A convincing but ultimately irrelevant object.
...
location: finale | A choice narrows the world.
  item: stories_within_the_walls_token | proof token | A concrete token that confirms what is really happening.
