...
_Slice tag: Slice 66 — Demonstration scenario for Stormfront Shift._

## Demo Purpose
Show the slice behaviour in a compact, testable scenario focused on: weather/environment systems and environmental state effects.
