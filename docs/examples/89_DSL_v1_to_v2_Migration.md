# DSL v1 to v2 Migration

_Slice tag: Slice 89 — Demonstration scenario for DSL v1 to v2 Migration._

## Demo Purpose
Show the slice behaviour in a compact, testable scenario focused on: migration command flow and compatibility reporting.
