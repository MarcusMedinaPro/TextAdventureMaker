# DSL v2 Story Chapters

_Slice tag: Slice 83 — Demonstration scenario for DSL v2 Story Chapters._

## Demo Purpose
Show the slice behaviour in a compact, testable scenario focused on: story branches and chapter progression.
