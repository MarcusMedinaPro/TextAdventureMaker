...
define item: folklore_three_voices_note | Case Note | A folded note containing partial context and names.
define item: folklore_three_voices_decoy | Red Herring | A convincing but ultimately irrelevant object.
define item: folklore_three_voices_token | Proof Token | A concrete token that confirms what is really happening.
define npc: folklore_three_voices_watcher | Watcher | A tense observer who reacts to your choices.
...
location: start | You arrive and assess the immediate danger.
  ...
  item: folklore_three_voices_note | case note| A folded note containing partial context and names. | aliases=case,note
  exit: north -> crossroads
  exit: east -> sidetrack

location: crossroads | You inspect clues and identify a fragile route forward.
  npc: folklore_three_voices_watcher
...
location: sidetrack | A false lead wastes time but reveals useful context.
  item: folklore_three_voices_decoy | red herring| A convincing but ultimately irrelevant object. | aliases=red,herring
...
location: finale | You commit to a risky path with limited certainty.
  item: folklore_three_voices_token | proof token| A concrete token that confirms what is really happening. | aliases=proof,token
  exit: south -> crossroads

// --- Start state ---
start_inventory: folklore_three_voices_note
start_stats: health=100 | resolve=50 | trust=0
flag: alarm_heard=false
counter: tension=0
relationship: folklore_three_voices_watcher=0
...
on_pickup: folklore_three_voices_token | effects="message:This detail is real. Build your choice around it."

npc_acceptance_default: folklore_three_voices_watcher | text="The watcher says little, but notes every move."
npc_rule: folklore_three_voices_watcher | when=counter.tension>=2 | priority=1 | then="message:The watcher glances away, as if expecting impact."
...
branch: sharp_end | when=has_item:folklore_three_voices_token | then="message:You reach the ending with evidence, not guesswork."
...
SetupC64("Folklore Three Voices");
