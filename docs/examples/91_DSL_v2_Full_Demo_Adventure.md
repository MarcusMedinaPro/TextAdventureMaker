# DSL v2 Full Demo Adventure

_Slice tag: Slice 91 — Demonstration scenario for DSL v2 Full Demo Adventure._

## Demo Purpose
Show the slice behaviour in a compact, testable scenario focused on: pure DSL v2 adventure end-to-end.
