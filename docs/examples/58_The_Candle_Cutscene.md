...
_Slice tag: Slice 58 — Demonstration scenario for The Candle Cutscene._

## Demo Purpose
Show the slice behaviour in a compact, testable scenario focused on: cinematic presentation, pauses, and staged reveal.
