// <copyright file="DockerAiCommandProvider.cs" company="Marcus Ackre Medina">
...
public sealed class DockerAiCommandProvider : JsonHttpAiCommandProviderBase
{
    private readonly DockerAiSettings _settings;

    public DockerAiCommandProvider(DockerAiSettings settings, HttpClient? client = null)
        : base(client, settings?.TimeoutMs ?? 8000)
    {
        _settings = settings ?? throw new ArgumentNullException(nameof(settings));
    }

    public override string Name => AiProviderNames.DockerAi;
