...
_Slice tag: Slice 78 — Demonstration scenario for DSL v2 NPC Triggers._

## Demo Purpose
Show the slice behaviour in a compact, testable scenario focused on: rule-driven dialogue and trigger execution.
