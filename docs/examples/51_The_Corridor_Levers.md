...
_Slice tag: Slice 51 — Demonstration scenario for The Corridor Levers._

## Demo Purpose
Show the slice behaviour in a compact, testable scenario focused on: directional actions and directional interaction parsing.
