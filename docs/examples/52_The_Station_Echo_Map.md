# The Station Echo Map

_Slice tag: Slice 52 — Demonstration scenario for The Station Echo Map._

## Demo Purpose
Show the slice behaviour in a compact, testable scenario focused on: spatial awareness, adjacency context, and room relations.
