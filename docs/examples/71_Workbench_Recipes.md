...
_Slice tag: Slice 71 — Demonstration scenario for Workbench Recipes._

## Demo Purpose
Show the slice behaviour in a compact, testable scenario focused on: crafting recipe registration and craft execution.
