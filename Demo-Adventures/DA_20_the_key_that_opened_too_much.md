...
location: start | The disturbance arrives and feels personal.
  ...
  item: the_key_that_opened_too_much_note | case note| A folded note containing partial context and names. | aliases=case,note
...
location: sidetrack | A clue reveals the scale of the problem.
  item: the_key_that_opened_too_much_decoy | red herring| A convincing but ultimately irrelevant object. | aliases=red,herring
...
location: finale | A choice narrows the world.
  item: the_key_that_opened_too_much_token | proof token| A concrete token that confirms what is really happening. | aliases=proof,token
