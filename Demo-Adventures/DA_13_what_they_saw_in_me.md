...
location: start | The disturbance arrives and feels personal.
  ...
  item: what_they_saw_in_me_note | case note | A folded note containing partial context and names.
...
location: sidetrack | A clue reveals the scale of the problem.
  item: what_they_saw_in_me_decoy | red herring | A convincing but ultimately irrelevant object.
...
location: finale | A choice narrows the world.
  item: what_they_saw_in_me_token | proof token | A concrete token that confirms what is really happening.
