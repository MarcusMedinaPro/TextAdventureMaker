# DSL v2 Quality Gates

_Slice tag: Slice 90 — Demonstration scenario for DSL v2 Quality Gates._

## Demo Purpose
Show the slice behaviour in a compact, testable scenario focused on: fixture corpus and CI validation gates.
