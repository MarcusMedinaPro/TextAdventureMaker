...
_Slice tag: Slice 56 — Demonstration scenario for Questions in the Kitchen._

## Demo Purpose
Show the slice behaviour in a compact, testable scenario focused on: advanced NPC communication, topic handling, and memory.
