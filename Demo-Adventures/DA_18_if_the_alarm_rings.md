...
location: start | The disturbance arrives and feels personal.
  ...
  item: if_the_alarm_rings_note | case note | A folded note containing partial context and names.
...
location: sidetrack | A clue reveals the scale of the problem.
  item: if_the_alarm_rings_decoy | red herring | A convincing but ultimately irrelevant object.
...
location: finale | A choice narrows the world.
  item: if_the_alarm_rings_token | proof token | A concrete token that confirms what is really happening.
