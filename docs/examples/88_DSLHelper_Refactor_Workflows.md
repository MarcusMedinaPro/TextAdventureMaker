# DSLHelper Refactor Workflows

_Slice tag: Slice 88 — Demonstration scenario for DSLHelper Refactor Workflows._

## Demo Purpose
Show the slice behaviour in a compact, testable scenario focused on: batch refactors, rename safety, and dry runs.
