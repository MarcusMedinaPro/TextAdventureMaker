# The Abandoned Tram Depot

_Slice tag: Slice 67 — Demonstration scenario for The Abandoned Tram Depot._

## Demo Purpose
Show the slice behaviour in a compact, testable scenario focused on: vehicles and teleporters with route constraints.
