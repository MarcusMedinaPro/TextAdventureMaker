# Machine Room Startup

_Slice tag: Slice 72 — Demonstration scenario for Machine Room Startup._

## Demo Purpose
Show the slice behaviour in a compact, testable scenario focused on: machine states, power/fuel, and machine interactions.
