# DSL v2 Event Automation

_Slice tag: Slice 80 — Demonstration scenario for DSL v2 Event Automation._

## Demo Purpose
Show the slice behaviour in a compact, testable scenario focused on: event/schedule/random automation from DSL.
