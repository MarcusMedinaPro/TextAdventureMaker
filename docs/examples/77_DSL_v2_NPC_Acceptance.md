# DSL v2 NPC Acceptance

_Slice tag: Slice 77 — Demonstration scenario for DSL v2 NPC Acceptance._

## Demo Purpose
Show the slice behaviour in a compact, testable scenario focused on: NPC base definitions and acceptance ladders.
