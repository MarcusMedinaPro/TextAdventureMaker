...
_Slice tag: Slice 64 — Demonstration scenario for Poison in the Rain._

## Demo Purpose
Show the slice behaviour in a compact, testable scenario focused on: status effects stacking, ticking, and expiry.
