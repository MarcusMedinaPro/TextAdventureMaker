...
_Slice tag: Slice 63 — Demonstration scenario for Run From the Collector._

## Demo Purpose
Show the slice behaviour in a compact, testable scenario focused on: chase/pursuit loops and distance pressure.
