...
location: start | The disturbance arrives and feels personal.
  ...
  item: the_same_morning_slightly_changed_note | case note | A folded note containing partial context and names.
...
location: sidetrack | A clue reveals the scale of the problem.
  item: the_same_morning_slightly_changed_decoy | red herring | A convincing but ultimately irrelevant object.
...
location: finale | A choice narrows the world.
  item: the_same_morning_slightly_changed_token | proof token | A concrete token that confirms what is really happening.
