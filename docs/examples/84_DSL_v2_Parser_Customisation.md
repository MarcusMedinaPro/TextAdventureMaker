# DSL v2 Parser Customisation

_Slice tag: Slice 84 — Demonstration scenario for DSL v2 Parser Customisation._

## Demo Purpose
Show the slice behaviour in a compact, testable scenario focused on: command aliases, direction aliases, and parser options.
