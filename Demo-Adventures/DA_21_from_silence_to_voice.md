...
location: start | The disturbance arrives and feels personal.
  ...
  item: from_silence_to_voice_note | case note | A folded note containing partial context and names.
...
location: sidetrack | A clue reveals the scale of the problem.
  item: from_silence_to_voice_decoy | red herring | A convincing but ultimately irrelevant object.
...
location: finale | A choice narrows the world.
  item: from_silence_to_voice_token | proof token | A concrete token that confirms what is really happening.
