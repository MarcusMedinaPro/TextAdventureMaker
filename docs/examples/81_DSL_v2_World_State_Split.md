# DSL v2 World State Split

_Slice tag: Slice 81 — Demonstration scenario for DSL v2 World State Split._

## Demo Purpose
Show the slice behaviour in a compact, testable scenario focused on: world/state two-file loading and save snapshots.
