# DSL v2 Variables and Expressions

_Slice tag: Slice 75 — Demonstration scenario for DSL v2 Variables and Expressions._

## Demo Purpose
Show the slice behaviour in a compact, testable scenario focused on: template interpolation and safe expressions.
