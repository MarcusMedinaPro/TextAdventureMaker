...
location: start | The disturbance arrives and feels personal.
  ...
  item: the_street_i_no_longer_recognise_note | case note | A folded note containing partial context and names.
...
location: sidetrack | A clue reveals the scale of the problem.
  item: the_street_i_no_longer_recognise_decoy | red herring | A convincing but ultimately irrelevant object.
...
location: finale | A choice narrows the world.
  item: the_street_i_no_longer_recognise_token | proof token | A concrete token that confirms what is really happening.
