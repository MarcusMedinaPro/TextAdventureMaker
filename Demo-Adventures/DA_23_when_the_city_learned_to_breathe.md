...
location: start | The disturbance arrives and feels personal.
  ...
  item: when_the_city_learned_to_breathe_note | case note | A folded note containing partial context and names.
...
location: sidetrack | A clue reveals the scale of the problem.
  item: when_the_city_learned_to_breathe_decoy | red herring | A convincing but ultimately irrelevant object.
...
location: finale | A choice narrows the world.
  item: when_the_city_learned_to_breathe_token | proof token | A concrete token that confirms what is really happening.
