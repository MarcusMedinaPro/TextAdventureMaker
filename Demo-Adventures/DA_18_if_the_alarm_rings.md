# Demo Adventure 18: If the Alarm Rings
...
```adventure
world: If the Alarm Rings
goal: Reach the final turn with enough context to act decisively.
current_location: start

// --- DSL v2 entity definitions ---
define item: if_the_alarm_rings_note | Case Note | A folded note containing partial context and names.
define item: if_the_alarm_rings_decoy | Red Herring | A convincing but ultimately irrelevant object.
define item: if_the_alarm_rings_token | Proof Token | A concrete token that confirms what is really happening.
define npc: if_the_alarm_rings_watcher | Watcher | A tense observer who reacts to your choices.
...
location: start | The disturbance arrives and feels personal.
  ...
  item: if_the_alarm_rings_note | case note| A folded note containing partial context and names. | aliases=case,note
  exit: north -> crossroads
  exit: east -> sidetrack

location: crossroads | A rule is broken or a boundary is crossed.
  npc: if_the_alarm_rings_watcher
...
location: sidetrack | A clue reveals the scale of the problem.
  item: if_the_alarm_rings_decoy | red herring| A convincing but ultimately irrelevant object. | aliases=red,herring
...
location: finale | A choice narrows the world.
  item: if_the_alarm_rings_token | proof token| A concrete token that confirms what is really happening. | aliases=proof,token
  exit: south -> crossroads

// --- Start state ---
start_inventory: if_the_alarm_rings_note
start_stats: health=100 | resolve=50 | trust=0
flag: alarm_heard=false
counter: tension=0
relationship: if_the_alarm_rings_watcher=0
...
on_pickup: if_the_alarm_rings_token | effects="message:This detail is real. Build your choice around it."

npc_acceptance_default: if_the_alarm_rings_watcher | text="The watcher says little, but notes every move."
npc_rule: if_the_alarm_rings_watcher | when=counter.tension>=2 | priority=1 | then="message:The watcher glances away, as if expecting impact."
...
branch: sharp_end | when=has_item:if_the_alarm_rings_token | then="message:You reach the ending with evidence, not guesswork."
