...
location: start | Arrive at the flat. Something feels wrong.
  ...
  item: the_flat_on_rye_lane_note | case note | A folded note containing partial context and names.
...
location: sidetrack | Enter the kitchen. The clock runs backwards.
  item: the_flat_on_rye_lane_decoy | red herring | A convincing but ultimately irrelevant object.
...
location: finale | Find a note in the bedroom. The handwriting is yours.
  item: the_flat_on_rye_lane_token | proof token | A concrete token that confirms what is really happening.
