...
location: start | The disturbance arrives and feels personal.
  ...
  item: down_the_stairwell_that_never_ends_note | case note | A folded note containing partial context and names.
...
location: sidetrack | A clue reveals the scale of the problem.
  item: down_the_stairwell_that_never_ends_decoy | red herring | A convincing but ultimately irrelevant object.
...
location: finale | A choice narrows the world.
  item: down_the_stairwell_that_never_ends_token | proof token | A concrete token that confirms what is really happening.
