...
_Slice tag: Slice 79 — Demonstration scenario for DSL v2 Quest Graph._

## Demo Purpose
Show the slice behaviour in a compact, testable scenario focused on: quest conditions, stages, and objective flow.
